...
**Dataset**: National Alzheimer’s Coordinating Center (NACC) UDS v3 (2015–2024), linked MRI supplement across 39 Alzheimer’s Disease Centers  
...
**Extension-**  
Multiple imputation for missing covariates; PET-based extension; hierarchical (center-level) AFT models; and Bayesian estimation to capture uncertainty and between-center variability.  
...
**Dataset**: Simulated Phase II Trial Data for Brodalumab (Psoriasis Therapy)  
